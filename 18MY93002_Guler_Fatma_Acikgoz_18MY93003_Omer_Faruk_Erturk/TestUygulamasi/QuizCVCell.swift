...
protocol SoruApp: class {
    func didChooseAnswer(btnIndex: Int)
}

class SorguUygulamasi: UICollectionViewCell {
    ...
    func getButton(tag: Int) -> UIButton {
        let btn=UIButton()
        btn.tag=tag
        btn.setTitle("Seçenek", for: .normal)
    ...
    let lblQue: UILabel = {
        let lbl=UILabel()
        lbl.text="Bu bir soru ve cevaplamanız gerekiyor?"
